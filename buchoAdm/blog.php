					...
					<div class="p-t-80 p-b-124 bo5-r h-full p-r-50 p-r-0-md bo-none-md">
						...
						<div class="blo4 p-b-63">
							<div class="pic-blo4 hov-img-zoom bo-rad-10 pos-relative">
								<a href="#">
									<img src=<?php echo "foto/" . $endereco; ?> alt="IMG-BLOG">
								</a>
							...
							<div class="text-blo4 p-t-33">
								<h4 class="p-b-16">
									<a href="blog-detail.php" class="tit9"><?php echo $linhaEvento['nome']; ?></a>
								</h4>
					...
					<div class="sidebar2 p-t-80 p-b-80 p-l-20 p-l-0-md p-t-0-md">
						...
						<div class="categories">
							...
							<ul>
								<li class="bo5-b p-t-8 p-b-8">
									<a href="#" class="txt27">
										Cooking recipe <!-- Receita culinária --><!-- Cooking recipe -->
									</a>
								</li>

								<li class="bo5-b p-t-8 p-b-8">
									<a href="#" class="txt27">
										Delicious foods <!-- Comidas Deliciosas --><!-- Delicious foods -->
									</a>
								</li>

								<li class="bo5-b p-t-8 p-b-8">
									<a href="#" class="txt27">
										Events Design <!-- Design de Eventos --><!-- Events Design -->
									</a>
								</li>

								<li class="bo5-b p-t-8 p-b-8">
									<a href="#" class="txt27">
										Restaurant Place <!-- Restaurante Place --><!-- Restaurant Place -->
									</a>
								</li>
						...
						<div class="popular">
							<h4 class="txt33 p-b-35 p-t-58">
								Most popular <!-- Mais popular --><!-- Most popular -->
							</h4>
							...
							<ul>
								<li class="flex-w m-b-25">
									...
									<div class="size28">
										<a href="#" class="dis-block txt28 m-b-8">
											Best Places for Wine <!-- Melhores lugares para vinho --><!-- Best Places for Wine -->
										</a>

										<span class="txt14">
											3 days ago <!-- 3 dias atrás --><!-- 3 days ago -->
										</span>
									</div>
								</li>
								...
								<li class="flex-w m-b-25">
									...
									<div class="size28">
										<a href="#" class="dis-block txt28 m-b-8">
											Eggs and Cheese <!-- Ovos e Queijo --><!-- Eggs and Cheese -->
										</a>

										<span class="txt14">
											July 2, 2017 <!-- 2 de Julho de 2017 --><!-- July 2, 2017 -->
										</span>
									</div>
								</li>
								...
								<li class="flex-w m-b-25">
									...
									<div class="size28">
										<a href="#" class="dis-block txt28 m-b-8">
											Style the Wedding Party <!-- Estilo a festa de casamento --><!-- Style the Wedding Party -->
										</a>

										<span class="txt14">
											May 28, 2017 <!-- 28 de Maio de 2017 --><!-- May 28, 2017 --> 
										</span>
									</div>
								</li>
								...
								<li class="flex-w m-b-25">
									...
									<div class="size28">
										<a href="#" class="dis-block txt28 m-b-8">
											Cooking recipe Delicious <!-- Receita culinária Deliciosa --><!-- Cooking recipe Delicious --> 
										</a>

										<span class="txt14">
											May 25, 2017 <!-- 25 de Maio de 2017 --><!-- May 25, 2017 -->
										</span>
									</div>
								</li>
								...
								<li class="flex-w m-b-25">
									...
									<div class="size28">
										<a href="#" class="dis-block txt28 m-b-8">
											Pizza is prepared fresh <!-- Pizza é preparada fresca --><!-- Pizza is prepared fresh --> 
										</a>

										<span class="txt14">
											May 2, 2017 <!-- 2 de Maio de 2017 --><!-- May 2, 2017 -->
										</span>
									</div>
								</li>
							</ul>
						...
						<div class="archive">
							<h4 class="txt33 p-b-20 p-t-43">
								Archive <!-- Arquivo --><!-- Arquive --> 
							</h4>

							<ul>
								<li class="flex-sb-m p-t-8 p-b-8">
									<a href="#" class="txt27">
										July 2018 <!-- Julho de 2018 --><!-- July 2018 --> 
									</a>
								...
								<li class="flex-sb-m p-t-8 p-b-8">
									<a href="#" class="txt27">
										June 2018 <!-- Junho de 2018 --><!-- June 2018 -->
									</a>
								...
								<li class="flex-sb-m p-t-8 p-b-8">
									<a href="#" class="txt27">
										May 2018 <!-- Maio de 2018 --><!-- May 2018 -->
									</a>
								...
								<li class="flex-sb-m p-t-8 p-b-8">
									<a href="#" class="txt27">
										April  2018 <!-- Abril 2018 --><!-- April 2018 -->
									</a>
								...
								<li class="flex-sb-m p-t-8 p-b-8">
									<a href="#" class="txt27">
										March 2018 <!-- Março de 2018 --><!-- March 2018 -->
									</a>
								...
								<li class="flex-sb-m p-t-8 p-b-8">
									<a href="#" class="txt27">
										February 2018 <!-- Fevereiro de 2018 --><!-- February 2018 -->
									</a>
								...
								<li class="flex-sb-m p-t-8 p-b-8">
									<a href="#" class="txt27">
										January 2018 <!-- Janeiro de 2018 --><!-- January 2018 -->
									</a>
								...
								<li class="flex-sb-m p-t-8 p-b-8">
									<a href="#" class="txt27">
										December 2017 <!-- Dezembro de 2017 --><!-- December 2017 -->
									</a>
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 p-t-50">
					...
					<h4 class="txt13 m-b-33">
						Contact Us <!-- Contate-nos --><!-- Contact-Us -->
					</h4>

					<ul class="m-b-70">
						<li class="txt14 m-b-14">
							<i class="fa fa-map-marker fs-16 dis-inline-block size19" aria-hidden="true"></i>
							8th floor, 379 Hudson St, New York, NY 10018 <!-- 8º andar, 379 Hudson St, Nova York, NY 10018 --><!-- 8th floor, 379 Hudson St, New York, NY 10018 -->
						</li>
					...
					<h4 class="txt13 m-b-32">
						Opening Times <!-- Horário de Funcionamento --><!-- Opening Times -->
					</h4>
				...
				<div class="col-sm-6 col-md-4 p-t-50">
					<!-- - -->
					<h4 class="txt13 m-b-33">
						Latest events <!-- Últimos eventos --><!-- Latest events -->
					</h4>
