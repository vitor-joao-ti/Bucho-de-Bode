<?php 
	...
	require 'conexao.php';
	$dadosEvento = mysqli_query($con, "SELECT * FROM evento WHERE idEvento = '$idEvento'");
...
<!-- Header -->
			...
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="social flex-w flex-l-m p-r-20">
						<a href=<?php echo "blog-detail.php?lang=" . !$lang."&idEvento=".$idEvento;?>><i class="fa fa-gear m-l-21" aria-hidden="true"></i></a>
	...
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(images/bg-title-page-02.jpg);">
		<h2 class="tit6 t-center">
			<?php echo $lang == true ? "Event Detail" : "Detalhe do Evento"; ?> <!-- Blog --><!-- Blog -->
		</h2>
	</section>
		...
		<div class="bread-crumb bo5-b p-t-17 p-b-17">
			<div class="container">
				<a href=<?php echo "index.php?lang=$lang";?> class="txt27">
					<?php echo $lang == true ? "Home" : "Inicio"; ?>  <!-- Inicio --><!-- Home -->
				</a>

				<span class="txt29 m-l-10 m-r-10">/</span>

				<a href=<?php echo "blog.php?lang=$lang";?> class="txt27">
					<?php echo $lang == true ? "Events" : "Eventos"; ?><!-- Blog --><!-- Blog -->
				</a>

				<span class="txt29 m-l-10 m-r-10">/</span>

				<span class="txt29">
					<?php echo $linhaEvento['nome']; ?> <!-- Culinária receita deliciosa --><!-- Cooking recipe delicious --> 
				</span>
			</div>
		</div>
