...
<body class="animsition">
			...
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="social flex-w flex-l-m p-r-20">
						<a href=<?php echo "menu.php?lang=" . !$lang;?>><i class="fa fa-gear m-l-21" aria-hidden="true"></i></a>
			...
			<div class="row p-t-108 p-b-70">
				...
				if ($totalPrato < 1) {
					if ($lang == false) {
						...
						echo "<h3>No dishes of this category have been registered!</h3>";
					}
				}else{
				if ($totalPrato) do{
				...
				<div class="col-md-8 col-lg-6 m-l-r-auto">	
					<div class="blo3 flex-w flex-col-l-sm m-b-30">
						<div class="pic-blo3 size20 bo-rad-10 hov-img-zoom m-r-28">
							<a href="#"><img alt="IMG-MENU" src=<?php echo "../BuchoAdm/foto/" . $endereco; ?> ></a>
						</div>
	...
	<section class="section-dinner bgwhite">
		<div class="header-dinner parallax0 parallax100" style="background-image: url(images/header-menu-02.jpg);">
			<div class="bg1-overlay t-center p-t-170 p-b-165">
				<h2 class="tit4 t-center">
					<?php echo $lang == true ? "Side Dish" : "Acompanhamento"; ?> <!-- Jantar --><!-- Dinner -->
				</h2>
			</div>
		</div>
	...
	<section class="section-dinner bgwhite">
		<div class="header-dinner parallax0 parallax100" style="background-image: url(images/header-menu-03.jpg);">
			<div class="bg1-overlay t-center p-t-170 p-b-165">
				<h2 class="tit4 t-center">
					<?php echo $lang == true ? "Dessert" : "Sobremesa"; ?>  <!-- Jantar --><!-- Dinner -->
				</h2>
			</div>
		</div>
	...
	<section class="section-dinner bgwhite">
		<div class="header-dinner parallax0 parallax100" style="background-image: url(images/header-menu-04.jpg);">
			<div class="bg1-overlay t-center p-t-170 p-b-165">
				<h2 class="tit4 t-center">
					<?php echo $lang == true ? "Drink's" : "Bebidas"; ?> <!-- Jantar --><!-- Dinner -->
				</h2>
			</div>
		</div>
