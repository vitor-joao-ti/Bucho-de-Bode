...
<!-- Header -->
			...
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="social flex-w flex-l-m p-r-20">
						<a href=<?php echo "reservation.php?lang=" . !$lang;?>><i class="fa fa-gear m-l-21" aria-hidden="true"></i></a>
	...
	<section class="section-reservation bg2-pattern p-t-115 p-b-120">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 p-b-30">
					<div class="t-center">
						<span class="tit2 t-center">
							<?php echo $lang == true ? "Registration" : "Cadastro"; ?>  <!-- Reservas --><!-- Reservation -->
						</span>

						<h3 class="tit3 t-center m-b-35 m-t-2">
							<?php echo $lang == true ? "Client" : "Cliente"; ?> <!-- Tabela de eventos --><!-- Book table -->
						</h3>
					</div>

					<form class="wrap-form-reservation size22 m-l-r-auto" method="POST" action="insertCliente.php">
						<div class="row">
							<div class="col-md-4">
								<!-- Name -->
								<span class="txt9">
									<?php echo $lang == true ? "Name" : "Nome"; ?> <!----><!-- Name -->
								</span>

								<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="nome" placeholder=<?php echo $lang == true ? "Name" : "Nome"; ?> required>
								</div>
							</div>
							...
							<div class="col-md-4">
								<!-- Phone -->
								<span class="txt9">
									<?php echo $lang == true ? "Password" : "Senha"; ?> <!-- Telefone --><!-- Phone -->
								</span>

								<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="password" name="senha" placeholder=<?php echo $lang == true ? "Password" : "Senha"; ?> required>
								</div>
							</div>
						...
						<div class="wrap-btn-booking flex-c-m m-t-6">
							...
							<button type="submit" class="btn3 flex-c-m size13 txt11 trans-0-4">
								<?php echo $lang == true ? "Sing In" : "Cadastrar"; ?> <!-- Tabela de Eventos --><!-- Book table -->
							</button>
						</div>
					</form>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 p-b-30">
					<div class="t-center">
						<span class="tit2 t-center">
							<?php echo $lang == true ? "Reservation" : "Reservas"; ?>
						</span>

						<h3 class="tit3 t-center m-b-35 m-t-2">
							<?php echo $lang == true ? "Book table" : "Formulário"; ?> <!-- Tabela de eventos --><!-- Book table -->
						</h3>
					</div>

					<form class="wrap-form-reservation size22 m-l-r-auto" method="POST" action="insertReserva.php">
						<div class="row">
							<div class="col-md-4">
								<!-- Date -->
								<span class="txt9">
									<?php echo $lang == true ? "Date" : "Data"; ?> <!-- Data --><!-- Date -->
								</span>
							...
							<div class="col-md-4">
								<!-- People -->
								<span class="txt9">
									<?php echo $lang == true ? "People" : "Pessoas"; ?><!--  --><!-- People -->
								</span>

								<div class="wrap-inputpeople size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<!-- Select2 -->
									<select class="selection-1" name="pessoa">
										<option value="1">1 person</option> <!-- 1 Pessoa --><!-- 1 Persom -->
										<option value="2">2 people</option> <!-- 2 Pessoas --><!-- 2 People -->
										<option value="3">3 people</option> <!-- 3 Pessoas --><!-- 3 People -->
										<option value="4">4 people</option> <!-- 4 Pessoas --><!-- 4 People -->
										<option value="5">5 people</option> <!-- 5 Pessoas --><!-- 5 People -->
										<option value="6">6 people</option> <!-- 6 Pessoas --><!-- 6 People -->
										<option value="7">7 people</option> <!-- 7 Pessoas --><!-- 7 People -->
										<option value="8">8 people</option> <!-- 8 Pessoas --><!-- 8 People -->
										<option value="9">9 people</option> <!-- 9 Pessoas --><!-- 9 People -->
										<option value="10">10 people</option> <!-- 10 Pessoas --><!-- 10 People -->
										<option value="11">11 people</option> <!-- 11 Pessoas --><!-- 11 People -->
										<option value="12">12 people</option> <!-- 12 Pessoas --><!-- 12 People -->
									</select>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-4">
								<!-- Name -->
								<span class="txt9">
									<?php echo $lang == true ? "Name" : "Nome"; ?> <!-- Nome --><!-- Name -->
								</span>
						...
						<div class="wrap-btn-booking flex-c-m m-t-6">
							<!-- Button3 -->
							<button type="submit" class="btn3 flex-c-m size13 txt11 trans-0-4">
								<?php echo $lang == true ? "Book Table" : "Reservar"; ?> <!-- Tabela de Eventos --><!-- Book table -->
							</button>
						</div>
					</form>
				</div>
			...
			<div class="info-reservation flex-w p-t-80">
				<div class="size23 w-full-md p-t-40 p-r-30 p-r-0-md">
					<h4 class="txt5 m-b-18">
						<?php echo $lang == true ? "Reserve by Phone" : "Reserve pelo Telefone"; ?> <!--  --><!-- Reserve by Phone -->
					</h4>
				...
				<div class="size24 w-full-md p-t-40">
					<h4 class="txt5 m-b-18">
						<?php echo $lang == true ? "For Event Booking" : "Para reservas de eventos"; ?> <!--  --><!-- For Event Booking -->
					</h4>
